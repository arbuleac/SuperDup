...
public class BookService extends IntentService {
    ...
    private void fetchBook(String ean) {
        ...
        if (bookJsonString == null || bookJsonString.isEmpty()) {
            Log.e(LOG_TAG, "Failed to load book from internet!");
        ...
        try {
            ...
            //Write the book last, so that the uri is notified only when all the data is inserted and this does not run into loading errors
